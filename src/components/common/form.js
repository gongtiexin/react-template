...
// import { Button, Cascader, Checkbox, DatePicker, Form, Icon, Input, Modal, Radio, Select, Switch, Upload } from 'antd';
//
...
//         };
//       }
//       control = getFieldDecorator(config.name, config.options)(<Select {...props}>
//         {options}
//       </Select>);
//       break;
//
